...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl
{
     ...
     * 放缩视频
     */
    public float scaleVideo(float changeScale)
    {
        currentScale = currentScale + changeScale;
        if (currentScale < 0.5)
        {// 最少50%
            currentScale = 0.5f;
        ...
        LayoutParams lp = getLayoutParams();
        lp.width = (int) (videoWidth * currentScale);
        lp.height = (int) (videoHeight * currentScale);
        setLayoutParams(lp);
        getHolder().setFixedSize(mSurfaceWidth, mSurfaceHeight);
        return currentScale;
    }
